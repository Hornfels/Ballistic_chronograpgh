...
void calibrate(void) {
    ...
    _delay((unsigned long)((100000)*(128000/4000.0)));
    _delay((unsigned long)((100000)*(128000/4000.0)));
    PORTD = 0x00;
    lcd_clear();
...
void debug_print() {
    ...
    while (1) {
        ...
        _delay((unsigned long)((25000)*(128000/4000.0)));
    }
}
...
double calculate_time(void) {
    ...
    int result = 0;
    result = timer_overflows * (65536 / (4000000 / 1000));
    result += (TMR0H * 256 + TMR0L) / (4000000 / 1000);
    return result;
...
void main(void) {
    ...
    print_threshold();
    _delay((unsigned long)((400000)*(128000/4000.0)));
    lcd_clear();
    lcd_goto(0);
    lcd_puts("Measuring");
